...
| `data/monetary_execution.py` | Registered prospective output basis, exact jurisdiction-specific composite conversion without intermediate rounding, and execution lineage. |
